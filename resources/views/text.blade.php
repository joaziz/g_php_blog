                    ...
                    <div class="row same-height align-items-center">
                        <div class="col-md-12 col-lg-6">
                            <div class="post-entry">
                                <span class="post-category text-white bg-success mb-3">{{$article->tag}}</span>
                                <h2 class="mb-4"><a href="#">
                                        {{$article->title}}
                                    </a></h2>
            ...
            <div class="row">
                <div class="col-lg-4 mb-5 mb-lg-0">
                    ...
                    <div class="entry2 mb-5">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quo sunt tempora dolor laudantium
                            sed
                            optio. laborum error in eum id veritatis quidem neque nesciunt at architecto nam ullam,
                            officia
                            unde dolores officiis veniam</p>
                    </div>
                    ...
                    <div class="entry4 d-block d-sm-flex">
                        <figure class="figure order-2"><a href="single.html"><img src="images/img_1.jpg" alt="Image"
                                                                                  class="img-fluid rounded"></a>
                        </figure>
                        <div class="text mr-4 order-1">
                            <span class="post-category text-white bg-primary mb-3">Sports</span>
